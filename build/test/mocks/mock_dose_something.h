...
#define DoesSomething_IgnoreAndReturn(cmock_retval) DoesSomething_CMockIgnoreAndReturn(__LINE__, cmock_retval)
...
#define DoesSomething2_IgnoreAndReturn(cmock_retval) DoesSomething2_CMockIgnoreAndReturn(__LINE__, cmock_retval)
